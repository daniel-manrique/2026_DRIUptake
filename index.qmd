...
::: notes
"We can argue then that uptake emphasizes connecting these aspects of research, more like a relay towers that only fulfill their purpose when they communicate with each other. So, when a researcher uses advanced compute for processing or generate data, we hope that data management allows them to handle different task without having a stroke. I think we are not there yet, but we are getting there, or doing our best to get there. And in particular, in Canada, we are building different environments, like RAIDs, which are research activity identifiers, that will facilitate this task. So, all this to say that that DRI uptake occurs when a researcher doesn't experience friction moving between these nodes."
:::
...
- **The Hidden Gap**: While capacity is growing, much of it goes unused or misused due to gaps in RDM skills.
...
::: notes
"Now, this is few quantitative evidence driving this need for interconnection in our country. The 2025 Resource Allocation Competition (RAC) from the Alliance, shows an increasing trend in the demand for resources. Our national ARC platform is now serving over 20,000 researchers, and with the investments done last year, we finally are able to surpass the capacity (which is the blue line) compared to the request. But these charts hide another uncomfortable truth that many of us are aware of. Much of that required space goes unused or is misused simply because of the widespread lack of competence in research data management. We know that hardware is finite. So, when resources are this competitive, data optimization becomes a must.We know that it is not just about hard drives to store petabytes of data, but also about strategies to manage them properly, ensure their documentation, and reduce waste. So this is another challenge if one intends to measure DRI uptake: to what extent do researchers have the skills to effectively manage these resources. This is something that, to my knowledge, it is still unkown in Canada and must be an active area of development. So, it is not about who or how many users a system have but also about what is the quality of the use and competence. "
:::
...
::: notes
"and when we fail to integrate RDM and software support precious infrastructure is wasted. Here is an example provided by Calcul Québec in the last DRI connect in Canada, where they explained that minitored unoptimized jobs and made 125 targeted interventions to help researchers correct their workflows. This was transformed in savings of $90,000 worth of compute waste. This example showcases that it is not precicely the case that researchers love to waste resources; but that they simply lack skills to optimize their workflows. Again, DRI uptake must measure this aspect of competence or skills."
:::
...
::: notes
"As we align with the RDA’s vision on driving DRI capacity and uptake, right now Canada is making several efforts to build a unified architecture known as the Canadian Research Data Platform. With this, we envisage to combine high-value compute resources with our incredibly rich national data, and data management tools, all supported by a distributed workforce of skilled professionals around the country. So, we hope that in the near future, by using persistent identifiers like RAiDs to glue together projects, data, and computations, we can create a sustainable ecosystem that could be the model for other countries. In this context, for us, measuring DRI uptake, will mean ensuring this interconnected machine works for every researcher in the country. Thank you for your attention."
:::

## {background-image="images/LastSlide.png" background-size="contain"}
